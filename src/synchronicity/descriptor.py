...
class OverloadedMethodDescriptor(typing.Generic[Surface_co]):
...
class OverloadedOnAccessDescriptor(typing.Generic[Surface_co]):
...
def wrapped_overloaded_method(
    ...
    def decorator(
        ...
        return OverloadedMethodDescriptor(sync_wrapper, surface_factory)
...
def wrapped_overloaded_classmethod(
    ...
    def decorator(
        ...
        return OverloadedOnAccessDescriptor(sync_wrapper, surface_factory)
