"""Copy the synchronicity2 *runtime* into a target package for vendoring."""
...
VENDORED_INIT = '''"""Vendored synchronicity2 (generated by `synchronicity2 vendor`).
...
def vendor_runtime(*, target_package: str, output_base: Path) -> Path:
    ...
    src_root = Path(synchronicity2.__file__).resolve().parent
...
def run_vendor_cli(argv: list[str] | None = None) -> None:
    parser = argparse.ArgumentParser(
        description="Copy synchronicity2 runtime and Module into a package tree for vendoring.",
