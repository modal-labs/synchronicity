...
* Synchronized *classes* need to have a reference to the wrapper class present somewhere to prevent instances of those classes from breaking. Typically an owner module of a class would keep such a reference.
